...
def query_to_pdf(query):
    ...
    htmldoc = HTML(html_file_name).write_pdf( pdf_file_name, stylesheets=[CSS(string='body { font-family: Times New Roman } table { background-color:#F4FAF9;border-collapse:collapse;} td,th { padding:5px;border:1px solid;} th { background-color:#05D7CC;} @page {size: Letter;  margin: 0in 0.44in 0.2in 0.44in; }')])
